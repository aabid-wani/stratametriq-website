      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-16">
        ...
        {product.hasLiveDemo && (
          <div id="demo" className="space-y-6">
            <div className="flex items-center justify-between border-b border-glass pb-4">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-electric-400 block">
              ...
              <span className="px-3 py-1 rounded-full bg-neon-cyan/10 border border-neon-cyan/30 text-neon-cyan text-xs font-bold font-mono hidden sm:block">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-3xl bg-obsidian-800/60 border border-glass space-y-3">
              <div className="p-3 rounded-2xl bg-obsidian-950 border border-glass w-fit text-electric-400">
                <Lock className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-white">Zero Cloud Exfiltration</h3>
            ...
            <div className="p-6 rounded-3xl bg-obsidian-800/60 border border-glass space-y-3">
              <div className="p-3 rounded-2xl bg-obsidian-950 border border-glass w-fit text-neon-cyan">
            ...
            <div className="p-6 rounded-3xl bg-obsidian-800/60 border border-glass space-y-3">
              <div className="p-3 rounded-2xl bg-obsidian-950 border border-glass w-fit text-neon-purple">
