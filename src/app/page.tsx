...
export default function BrandHome() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-obsidian">
      ...
      <section id="demos" className="py-20 bg-obsidian-900/40 border-t border-glass relative">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-3">
              <button
                ...
                className={`px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold flex items-center space-x-2 transition-all ${
                  activeDemo === "vscode"
                    ...
                    : "bg-obsidian-800/80 border border-glass text-gray-400 hover:text-white"
                }`}
              >
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold flex items-center space-x-2 transition-all ${
                  activeDemo === "idcard"
                    ? "bg-gradient-to-r from-neon-cyan to-blue-600 text-obsidian shadow-glow-cyan scale-105"
                    : "bg-obsidian-800/80 border border-glass text-gray-400 hover:text-white"
                }`}
              >
